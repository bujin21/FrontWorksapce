...
class Hamster extends Pet{
    ...
    info() : void{
        console.log(`이 햄스터는 ${this.kind} 햄스터종이며, 이름은 ${this.name}입니다.`);
        if(this.food){
...
type ProductUpdateInput = 
   Omit<Product, "category" | "description" | "stock">  // id, name, price (필수)
    & Partial<Pick<Product, "description" | "stock">>;    // description, stock (선택)

const product1:ProductUpdateInput = {id:1,name:'galaxy1',price:500000};
const product2:ProductUpdateInput = {id:2,name:'galaxy2',price:1000000, description: '멋진상품입니다.',stock:5};
