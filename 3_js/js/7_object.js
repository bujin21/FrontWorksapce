test1.onclick = function(){
    ...
    */
    ...
    obj2.price = 3000; // {price : 3000}
    // 2) 브래킷표기법(bracket notation)
    // - 브래킬표기법은 속성명을 반드시 문자열 리터럴 혹은
    //   문자열 변수를 제시해야 한다.
    obj2['origin'] ='필리핀';

    //문자열에 특수문자, 띄어쓰기 등이 포함된 경우 대괄호표기법
    // 사용할 것
    obj2['ty-pe'] = '피클';
...
test7.onclick = function(){
   ...
   function Pet(kind, name, breed, weight){
        // 필드부
        //  - 생성자 함수 내부에 this는 현재 생성된 객체의 주소값을 의미한다.
        this.kind = kind;
        this.name = name;
        this.breed = breed;
        this.weight = weight;
...
test8.onclick = function(){
    ...
    */
    ...
    console.log(Math.floor(156 /5, 1));
};