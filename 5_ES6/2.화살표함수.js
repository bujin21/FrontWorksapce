...
const obj3 = {
    ...
    arrowFn : function(){
        ...
        console.log(getName()); // arrowFn의 this를 공유하므로 객체3

        const getName2 = function(){
            return this.name;
        }

        console.log(getName2()); // 글로벌의 this.name
    }
}
...
/*
    ...
    1) 화살표 함수를 사용하는게 적합한 경우
     ...
     - 상위스코프의 this를 그대로 유지해야 하는 콜백함수 사용자
*/
...
// - 합수의 this를 첫번째 인자로 전달된 값으로 변경한 후 호출
...
printName.apply({name : 'jbj'}, ['hello', 'Mr.Jeon']);
