            ...
            <tr>
              ...
              <td colSpan={3}>
                <input type='text' name='boardTitle' 
                  value={board.boardTitle} onChange={onInputHandler}/>
              </td>
            </tr>
            <tr>
              <th>작성자</th>
              <td colSpan={3}>
                ...
                value={board.boardWriter} onChange={onInputHandler}/>
              </td>
            </tr>
            <tr>
              <th>글내용</th>
              <td colSpan={3} style={ { height: "200px" }  }>
                ...
                value={board.boardContent} onChange={onInputHandler}></textarea>
              </td>
            </tr>
            <tr>
